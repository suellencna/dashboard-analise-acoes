...
def enviar_email_ativacao_simples():
    """Enviar email de ativação simples com link direto"""
    ...
    # Link direto para o Render (que já está funcionando)
...
if __name__ == "__main__":
    print("🧪 Teste de Email de Ativação - Simples")
    print("=" * 50)
    
    enviar_email_ativacao_simples()
