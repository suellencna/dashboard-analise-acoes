...
def enviar_email_ativacao_github_raw():
    """Enviar email de ativação com link do GitHub Raw"""
    ...
    # URL do GitHub Raw
    url_github_raw = "https://raw.githubusercontent.com/suellencna/dashboard-analise-acoes/main/ativacao_github_pages_final.html"
    link_ativacao = f"{url_github_raw}?token={token}"
...
if __name__ == "__main__":
    print("🧪 Teste de Email de Ativação - GitHub Raw")
    print("=" * 50)
    
    enviar_email_ativacao_github_raw()
